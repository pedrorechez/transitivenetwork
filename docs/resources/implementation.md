...
For more information about the contract code, please refer [this](./resources/contract-usage.html) 
document.
...
* Contract usage: [Implementation](./resources/contract-usage.html)
